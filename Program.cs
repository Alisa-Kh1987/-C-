...
//выводим значение переменной number
...
//оцениваем, является ли первое число квадратом второго
...
//}
//else {
 //  Console.WriteLine("значения чисел одинаковы");
//}

//Свой первоначальный вариант (не совсем верно учла условие, ЧТО надо вывести на экран - не столько максимум, сколько то, какое число больше/меньше второго. Ну и про лишнее if не учла)
...
else {Console.WriteLine("Введенные значения одинаковы");
}